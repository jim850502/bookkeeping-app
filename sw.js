const CACHE='driver-bookkeeping-v7';
const ASSETS=['./','./index.html','./manifest.json','./icon.svg','./taxiii-sync-adapter.js','./taxiii-sync-panel.html','./taxiii-details.html','./taxiii-fare-audit.html'];
